...
def display_popup(title, text, challenge_name): #game content
...
def display_popup2(title, text, challenge_name): #victory
    screen.fill((255, 255, 255))
    screen.blit(game_image, (0, 0))
    pygame.draw.rect(screen, (251, 255, 243), (100, 150, 700, 400))
...
def challenges(file): #questions from file to the screen
    how_many_lines = 0
    data = []
