...
def display_instructions():
    ...
    Embark on a journey full of laughter, friendship, and a hint of mischief. "Drinking Friends" is not just a board game; it's a ticket to memorable moments and endless fun.

    When you roll the dice and move on the board, you'll encounter challenges inspired by classic party games like "Never Have I Ever" and "Truth or Dare." Brace yourself for unexpected twists and hilarious revelations!

    Instructions:
    - Click on the game board to start this epic adventure.
    - Roll the dice, move your token, and face the challenges that await you.
    - You win by reaching the coveted "FINISH" square, but remember, the real victory lies in the shared moments and the joy of the game.

    Gather your friends, pour your favorite drinks, and let the games begin! Are you ready for the "Drinking Friends" experience?

    Click 's' to start the game and let the laughter flow!
    """
    ...
    try:
        while True:
            ...
            if welcome_screen and not instructions_screen:
                ...
                display_message("Click on the game board to start the game", y_offset=50)
                pygame.display.flip()
